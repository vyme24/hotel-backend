...
const sendLoginAlertEmail = async (to, name, time) => {
  ...
  const message = `
    Hello ${name},<br><br>
    We noticed a new login to your account on ${time}.<br>
    If this was not you, please secure your account immediately.<br><br>
    Location: ${location.ip}, ${location.countryCode}, ${location.region}, ${location.city}<br><br>
    Best regards,<br>The Team
  `;
  await SendMail(to, subject, message);
};
